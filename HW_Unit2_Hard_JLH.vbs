...
ws.Activate
    ...
    'Set Max Percent to 0
    Max_Percent = 0
    
    'Set Max Decrease to 0
    Max_Decrease = 0
    ...
    For i = 2 To LastRow
        ...
        If Cells(i, 11).Value > Max_Percent Then
            ...
            Range("Q2").Value = Format(Max_Percent, "Percent")
        End If
    Next i
    
    'For Loop Max Decrease
    For i = 2 To LastRow
    ...
    For i = 2 To LastRow
        If Cells(i, 12).Value > Max_Volume Then
            ...
            Range("Q4").Value = Format(Max_Volume, "#,###")
            'MsgBox (Reference_Row)
        End If
    Next i
...
'Center headers
Range("I1:Q1").HorizontalAlignment = xlCenter

'Last_Price_Row
'Last_Price_Row = Cells(Rows.Count, 10).End(xlUp).Row
